...
exports.FieldNamePattern = exports.TypeNamePattern = exports.Pattern = exports.FieldName = exports.TypeName = void 0;
 ...
 *
 */
class TypeNamePattern extends Pattern {
    constructor(value) {
        super(value);
    }
}
exports.TypeNamePattern = TypeNamePattern;
//#region `'TypeName;AnotherTypeName;'`
TypeNamePattern.forTypeNames = (typeNames) => {
    typeNames = (0, utils_js_1.arrayWrap)(typeNames);
    if (typeNames.length < 1) {
        throw new Error('Pattern cannot be created... No TypeNames were specified');
    }
    return TypeNamePattern.fromString((0, utils_js_1.arrayWrap)(typeNames)
...
TypeNamePattern.matchAndConfigureTypeNames = (pattern, typeName) => {
    ...
    (0, utils_js_1.resetIndex)(regexp);
    let result;
...
TypeNamePattern.matchAndConfigureAllTypeNamesExcludeTypeNames = (pattern, typeName) => {
    ...
    while ((result = regexp.exec(pattern.value)) !== null) {
        const _typeNames = (0, utils_js_1.strToList)(result.groups.typeNames);
 ...
 *
 */
class FieldNamePattern extends Pattern {
    constructor(value) {
        super(value);
    }
}
exports.FieldNamePattern = FieldNamePattern;
...
FieldNamePattern.forFieldNamesOfTypeName = (data) => {
    ...
    data.forEach(([typeNames, fieldNames]) => {
        const _typeNames = (0, utils_js_1.arrayWrap)(typeNames);
        const _fieldNames = (0, utils_js_1.arrayWrap)(fieldNames);
...
FieldNamePattern.matchAndConfigureFieldNamesOfTypeName = (pattern, typeName, fieldName) => {
    ...
    while ((result = regexp.exec(pattern.value)) !== null) {
        ...
        const _fieldNames = (0, utils_js_1.strToList)(result.groups.fieldNames);
...
FieldNamePattern.forFieldNamesOfAllTypeNames = (fieldNames) => {
    fieldNames = (0, utils_js_1.arrayWrap)(fieldNames);
