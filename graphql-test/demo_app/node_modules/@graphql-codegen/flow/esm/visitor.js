...
import { BaseTypesVisitor, DeclarationBlock, getConfigValue, indent, transformComment, wrapWithSingleQuotes, } from '@graphql-codegen/visitor-plugin-common';
...
export class FlowVisitor extends BaseTypesVisitor {
    ...
    FieldDefinition(node) {
        ...
        const comment = transformComment(node.description, 1);
        return (comment +
            indent(`${this.config.useFlowReadOnlyTypes ? '+' : ''}${node.name}${namePostfix}: ${typeString},`));
    }
